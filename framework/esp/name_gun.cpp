...
void Namegun::Init() {
    ...
    GunData[10006] = { "DROP TRUCK", "", true };
    GunData[-15524 + 25000] = { "Mini Healing Drone", "", true };
    GunData[-15521 + 25000] = { "Mini Healing Drone (1 USE)", "", true };
    GunData[21001] = { "Care Pistol", "\ue066", true };
    ...
    // Grenade
    GunData[601] = { "Grenade", "\ue080" };
    GunData[603] = { "Smoke Grenade\xE7""a", "\uE086" };
    GunData[1201] = { "Gel Wall", "\ue081" };
    GunData[1204] = { "Gel Wall", "\ue081" };
...
std::string Namegun::GetGunName(short gunId) {
    try {
        ...
        std::cout << "[UNKNOWN WEAPON] ID: " << gunId << " needs to be added!" << std::endl;
        return "ID: " + std::to_string(gunId);
    }
    catch (const std::exception& ex) {
        std::cout << "Error obtaining weapon name: " << ex.what() << std::endl;
        return "Unknown";
    }
}
...
std::string Namegun::GetGunIcon(short gunId) {
    try {
        ...
        std::cout << "Error getting weapon icon: " << ex.what() << std::endl;
        return "Unknown";
    }
}
